...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.545, 0.271, 0.075, 1.0); // Brown color similar to wood
        this.material4.setDiffuse(0.545, 0.271, 0.075, 1.0); // Brown color similar to wood
        this.material4.setSpecular(0, 0, 0, 1.0); // Low specular component
