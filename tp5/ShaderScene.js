...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders[9].setUniformsValues({ norm: 1, time: 0 });
		this.testShaders[10].setUniformsValues({ norm: 1, time: 0});
		//this.testShaders[11].setUniformsValues({ norm: 1, time: 0});
