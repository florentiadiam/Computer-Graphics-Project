...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
       ...
       // this.gui.add(this.scene, 'MyTriangleBig').name('Display Triangle B');
        ...
        //Checkbox elemment for Unit Cube Quad
         this.gui.add(this.scene, 'MyUnitCubeQuad').name('Unit Cube Quad');
        

        //Checkbox elemment for Tangram
        //this.gui.add(this.scene, 'MyTangram').name('Display Tangram');
