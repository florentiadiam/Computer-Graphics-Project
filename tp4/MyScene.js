...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cube = new MyUnitCubeQuad(this,'images/mineTop.png','images/mineSide.png','images/mineSide.png',
                                        'images/mineSide.png','images/mineSide.png','images/mineBottom.png');
    ...
    updateAppliedTexture() {
        this.quadMaterial.loadTexture(this.textures[this.selectedTexture]);
    }
    ...
    display() {
        ...
        if(this.MyQuad) this.quadMaterial.apply();
        ...
        if(this.MyQuad)this.quad.display();
